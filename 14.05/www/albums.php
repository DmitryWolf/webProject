...
<body>
    ...
    <?php
      ...
      $result = $mysqli->query("SELECT id, name, artist_id, genre_id, release_date, picture FROM albums");
      ...
      <th><font color=FFFFFF> Id исполнителя </font></th>
      <th><font color=FFFFFF> Id жанра </font></th>
      <th><font color=FFFFFF> Дата релиза </font></th>
      <th><font color=FFFFFF> Фото </font></th>
      </tr>";
      while ($myrow = mysqli_fetch_array($result)) {
        ...
        <td><font color=FFFFFF>$artist_id</font></td>
        <td><font color=FFFFFF>$genre_id</font></td>
        <td><font color=FFFFFF>$release_date</font></td>
        <td><font color=FFFFFF>$picture</font></td>
        </tr>";
      }
    ?>
