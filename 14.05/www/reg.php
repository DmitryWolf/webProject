...
<form name=myform1 action=index.html method=POST>
  ...
  <div class="box">
    <h2>Registration</h2>
    <form id="formElem" action="tablewithusers.php" method=POST>
        <div class="input-box">
        ...
        <div class="center">
          <input type="submit" value="Registration">
            <?php
              ...
              #$log = mysqli_real_escape_string($con_str, $_POST['login']);
              #$pass = mysqli_real_escape_string($con_str, $_POST['password']);
              
              $query_str="INSERT INTO `musicallibrary`.`users` (`login`, `password`) VALUES ('".$log."', '".$pass."')";
              #echo $query_str;
