...
<table cellpadding="0" border="0" align="center" width="100%" height="100%">
    ...
    <tr>
      ...
      <div class="btext">
	      <input type="text" id="btext-input" placeholder="Поиск" name="genreSearch" autocomplete="off" required>
      </div>
      </div>
      </td>
      <td align="center" width="10%">
    ...
    <?php
      ...
      $result = $mysqli->query("SELECT name, description FROM genres");
